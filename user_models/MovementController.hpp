...
private:
    enum State {IDLE, PREP_MOVE_FWD,PREP_MOVE_FWDS, MOVE_FWD,MOVE_FWDS, MX_STOP, WAIT_DATA, PREP_TURN, TURN_ALPHA, PREP_STOP, PREP_TURN2,PREP_TURN3, MX_STOP2,MX_STOP3};
	...
	TIME uturnTime = TIME(00,00,50,000);
...
public:
    ...
    std::vector<MSG> out() const noexcept {
    	...
    	else if(_state== MX_STOP || _state== MX_STOP2 || _state== MX_STOP3 || _state==TURN_ALPHA || _state== PREP_STOP)
    	{
