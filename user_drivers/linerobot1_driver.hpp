/*
 * linerobot1_driver.hpp
 *
 *  Created on: Mar 7, 2018
 *      Author: War-Mac
 */

#ifndef LINEROBOT1_DRIVER_HPP_
#define LINEROBOT1_DRIVER_HPP_
...
bool MOVER_OUT<TIME, MSG>::pDriver(Value& v) const noexcept{ //motor left
	...
	if(v == 1){
	  ...
	  //printf("M1 - BKWD \n");
			...
			float i = 0.01;
		while (i <= 0.30 && bot.getCentreSensor() != 0 && bot.getLeftSensor() != 0 && bot.getRightSensor() != 0 && bot.outLeftSensor() != 0 && bot.outRightSensor() != 0){
			bot.left_motor(i);
			i = i + 0.0000001 ;
